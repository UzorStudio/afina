...
def Menu(message):
    if message.text == "bot: кто я?":
        ...
        Да защитит тебя патриархат от феминизма, мой дорогой друг!\n 
Ты находишься в безопасном пространстве, \nгде можешь ссаться кипятком от смеха и эдьюкейтить себя,\n 
чтобы быть выше и сильнее феминисток!

Каждый участник бота может являться неотъемлемой частью\n сотворения адекватности и просвещения! Для вас\n мы сделали предложку и верим, что вы будете правильно ей пользоваться.\n (А не как фемки своей вагиной)
